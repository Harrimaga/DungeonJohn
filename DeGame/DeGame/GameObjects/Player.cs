...
public class Player : SpriteGameObject
{
    ...
    public bool onWeb = false, onIce = false, onSolid = false, next = false;
    bool startup = true;
    new public bool Mirror = false;
    public double damagereduction = 1, damagemultiplier = 1;
    public double attackspeedreduction = 1;
    public double attackmultiplier = 1;
    public double speed, extraspeed = 1;
    public float velocitybase = 0.3f;
    public float attack, extraattack = 0;
    public float health = 100, maxhealth = 100;
    public float exp = 0;
    float shoottimer = 0, nextLevelExp = 400;
