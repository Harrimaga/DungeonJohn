...
public class Boss1 : Boss
{
    ...
    public void Shoot()
    {
        ...
        if (Counter <= 0)
        {
            ...
            {
                bullet1 = new BossBullet(bulletdamage, speed, position + new Vector2(0 - bulletsprite.Width, (sprite.Height / 2) - (2 *bulletsprite.Height) + 10), SpriteEffects.FlipHorizontally , Hmng);
