...
public class TurretDownEnemy : Enemy
{
    int Counter = 0;
    ...
    public TurretDownEnemy(Vector2 startPosition, Vector2 roomposition, int layer = 0, string id = "Enemy") : base(startPosition, roomposition, layer, id)
    {
